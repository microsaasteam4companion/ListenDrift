# 🚨 QUICK FIX - Add Audience Selection UI
...
1. After `<div className="animate-fade-in">`
2. BEFORE `{/* Critical Alert */}`

### Copy This Code:
See file: `.gemini/INSERT_AT_LINE_680.tsx`
...
5. You should see "Target Audience" section with chips
6. Click different audiences to see analysis change

## 🎯 What You'll See:
- **Target Audience** heading
- 5 chips: Students, Professionals, Interviews, Marketing, General
- 4 cards in 2x2 grid:
  1. Audience Fit Score (with progress bar)
  2. Audience Mismatches (bullet list)
  3. Improvement Suggestions (checkmarks)
  4. Structural Insights (key-value pairs)
...
If the backend doesn't have this yet, the section won't show until you implement it.
